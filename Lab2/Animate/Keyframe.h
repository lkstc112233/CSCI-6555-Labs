...
/**
 * A template class for keyframe. It handles the data we interest in in one
 * place.
 */
class Keyframe {
 private:
 ...
 public:
  Keyframe(float timestampi, float xi, float yi, float zi,
  ...
  /**
   * Returns the transcation matrix of the keyframe. Including rotation,
   * scale(Not implemented), and transcations.
   */
